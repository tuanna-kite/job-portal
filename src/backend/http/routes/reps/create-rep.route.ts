...
import {
  CreateRepSchema,
  RepEntity,
} from "@/shared/validation/reps/create-rep.schema";
import { successDto } from "@/shared/validation/utils";

export const createRepRoute = createRoute({
  method: "post",
  path: "/reps",
  tags: ["Reps"],
  summary: "Create a new representative profile in the system",
  request: {
    body: {
      required: true,
      content: {
        "application/json": { schema: CreateRepSchema },
      },
    },
  },
  responses: {
